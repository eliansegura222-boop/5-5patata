...
if game.PlaceId ~= 537413528 then
    ...
    Gate.Size = UDim2.fromOffset(500, 250)
    ...
    for i = 1, (UserInputService.TouchEnabled and 70 or 110) do
        local dot = Instance.new("Frame")
...
local DOT_COUNT = UserInputService.TouchEnabled and 80 or 120
...
Title.Size = UDim2.new(1, -315, 1, 0)
...
ENV.__HX_HeaderLogo.Position = UDim2.new(0, 18, 0.5, 0)
ENV.__HX_HeaderLogo.Size = UDim2.fromOffset(34, 34)
...
ENV.__HX_DiscordButton.Position = UDim2.new(1, -102, 0.5, 0)
ENV.__HX_DiscordButton.Size = UDim2.fromOffset(92, 34)
...
ENV.__HX_DiscordButton.TextSize = 10
...
local Close = topButton("×", -14, Theme.danger)
local Minimize = topButton("−", -56, Theme.text)
...
NavTitle.Size = UDim2.new(1, 0, 0, 24)
    ...
    openModal("Selecciona un barco", function()
        local function buildPreset(level, purchaseChoice)
            ...
            local okBuild, errBuild = pcall(function()
                ...
                local placed = 0
                local usedMaterials = {}
                local delayPerBlock = UserInputService.TouchEnabled and 0.080 or 0.055
