...
do
    ...
    local function doRestore()
        ...
        -- Usar la posición actual del icono (donde el usuario lo dejó)
        local openPos = menu.Position
        savedPos = openPos
    ...
    local function module_script()
		...
		function FUNCTIONSmodule.loader(module)
			...
			local categoryAliases = {
				["ESPs"] = H3XA_MM2_LANGUAGE == "ES" and "VISUALES" or "VISUALS",
				["Tools"] = H3XA_MM2_LANGUAGE == "ES" and "COMBATE" or "COMBAT",
				["Detectables"] = H3XA_MM2_LANGUAGE == "ES" and "EXTRAS" or "EXTRAS",
				["Fun"] = H3XA_MM2_LANGUAGE == "ES" and "DIVERSION" or "FUN"
			}
			...
			local categoryIcons = {
				["ESPs"] = "rbxassetid://10723346959",       -- eye
				["Tools"] = "rbxassetid://10734975692",      -- swords
				["Detectables"] = "rbxassetid://10734966248",-- star
				["Fun"] = "rbxassetid://10734964441"         -- smile
			}
			...
			for _, section in ipairs(sections) do
				...
				for _, item in ipairs(section.items) do
					...
					elseif item["Type"] == "Range" then
						...
						clonerange.Size = UDim2.new(1, 0, 0, 40)
						clonerange.TextLabel.Text = H3XA_MM2_T(item["Args"][1])
						clonerange.TextLabel.TextColor3 = FUNCTIONSmodule.getTheme().textColor
						clonerange.TextLabel.Font = Enum.Font.GothamMedium
						...
						slider.Dragged = function(pos: UDim2)
							...
							pcall(function()
								...
								clonerange.Frame.Track.TrackProgress.Text = tostring(resolvedVal)
							end)
							rangeValueStates[item["Args"][1] .. module.Name] = resolvedVal
							if item["Args"][5] then
