...
local function resize()
    ...
    if mobile then
        local keyW = math.clamp(v.X - 56, 278, 326)
        keyPanel.Size = UDim2.fromOffset(keyW, 250)
        keyGlowOuter.Size = UDim2.fromOffset(keyW + 14, 264)
        languagePanel.Size = UDim2.fromOffset(math.clamp(v.X - 42, 286, 340), 232)
    else
        keyPanel.Size = UDim2.fromOffset(350, 262)
        keyGlowOuter.Size = UDim2.fromOffset(364, 276)
