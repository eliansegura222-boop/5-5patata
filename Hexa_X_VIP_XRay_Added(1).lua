...
if MOBILE_DEVICE then
	...
	CategoryUI.Frame.Size = UDim2.new(1, -12, 0, 46)
else
	CategoryUI.Frame.Position = UDim2.new(0, 6, 0, 110)
	CategoryUI.Frame.Size = UDim2.new(0, 138, 1, -116)
end

CategoryUI.Title = Instance.new("TextLabel")
CategoryUI.Title.Name = "HexaCategoryTitle"
CategoryUI.Title.BackgroundTransparency = 1
CategoryUI.Title.Position = UDim2.new(0, 10, 0, 8)
...
CategoryUI.Scroll.Position = MOBILE_DEVICE and UDim2.new(0, 5, 0, 5) or UDim2.new(0, 8, 0, 36)
CategoryUI.Scroll.Size = MOBILE_DEVICE and UDim2.new(1, -10, 1, -10) or UDim2.new(1, -16, 1, -44)
...
function CategoryUI:RefreshButtons()
	for key, button in pairs(self.Buttons) do
		...
		if stroke then
			...
			stroke.Transparency = selected and 0.28 or 0.84
...
for index, definition in ipairs(CategoryUI.Definitions) do
	...
	button.Size = MOBILE_DEVICE and UDim2.fromOffset(math.max(72, #definition.Label * 6 + 18), 30) or UDim2.new(1, -10, 0, 32)
	button.BackgroundColor3 = Theme.Panel2
...
Content.Position = MOBILE_DEVICE and UDim2.new(0, 2, 0, 160) or UDim2.new(0, 148, 0, 108)
Content.Size = MOBILE_DEVICE and UDim2.new(1, -4, 1, -162) or UDim2.new(1, -150, 1, -110)
...
task.spawn(function()
	local moduleOk, moduleError = xpcall(function()
		...
		local function isPlayerCharacterPart(object)
			...
			for _, player in ipairs(Players:GetPlayers()) do
				local character = player.Character
				if character and object:IsDescendantOf(character) then return true end
			end
			return false
		end
